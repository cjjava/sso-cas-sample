package com.cjoop.client.c.controller;
...
@RestController
public class ClientDProxyController {
	String targetUrl = "https://d.milkoutlet.com:6443/test.html";
	
	@RequestMapping(value="/pt/d/test",produces="text/html;charset=UTF-8")
